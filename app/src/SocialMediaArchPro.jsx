...
export default function SocialMediaIntelArchitectureDiagram() {
  ...
  const downloadSvg = () => {
    ...
    link.href = url;
    link.download = "map6-pro-architecture.svg";
  ...
  const nodes = useMemo(
    () => ({
      ...
      calendar: { id: "calendar", title: "Calendario", subtitle: "Agenda + eventos", x: 895, y: 300, w: 250, h: 76, color: C.calendarFlow },
      ingest: { id: "ingest", title: "API + Python", subtitle: "Ingestion pipeline", x: 760, y: 500, w: 250, h: 88, color: C.ingestFlow },

      openai: { id: "openai", title: "OpenAI GPT-4o", subtitle: "Classify + summarize", x: 140, y: 760, w: 280, h: 72, color: C.backend },
      gemini: { id: "gemini", title: "Google Gemini", subtitle: "Multimodal analysis", x: 140, y: 860, w: 280, h: 72, color: C.backend },
      claude: { id: "claude", title: "Anthropic Claude", subtitle: "Long-context reasoning", x: 140, y: 960, w: 280, h: 72, color: C.backend },

      hub: { id: "hub", title: "n8n Orchestrator", subtitle: "Workflow engine + routing", x: 530, y: 850, w: 340, h: 96, color: C.backend, badge: "ACTIVE" },

      auth: { id: "auth", title: "Supabase Auth", subtitle: "JWT + RLS", x: 980, y: 760, w: 280, h: 72, color: C.backend },
      edge: { id: "edge", title: "Edge Functions", subtitle: "Deno API layer", x: 980, y: 860, w: 280, h: 72, color: C.backend },
      langfuse: { id: "langfuse", title: "Langfuse", subtitle: "Tracing + cost", x: 980, y: 960, w: 280, h: 72, color: C.backend },

      postgres: { id: "postgres", title: "PostgreSQL", subtitle: "Relational data", x: 505, y: 1200, w: 195, h: 72, color: C.data },
      redis: { id: "redis", title: "Redis", subtitle: "Session + memory", x: 720, y: 1200, w: 195, h: 72, color: C.data },
      pinecone: { id: "pinecone", title: "Pinecone", subtitle: "Vector retrieval", x: 935, y: 1200, w: 195, h: 72, color: C.data },
      r2: { id: "r2", title: "Cloudflare R2", subtitle: "Document storage", x: 1150, y: 1200, w: 195, h: 72, color: C.data },

      adminPortal: { id: "adminPortal", title: "Admin Portal", subtitle: "Tenants, roles, billing", x: 60, y: 1200, w: 240, h: 72, color: C.admin },
      ragControl: { id: "ragControl", title: "RAG Control", subtitle: "Uploads + namespaces", x: 60, y: 1290, w: 240, h: 72, color: C.admin },
    }),
    []
  );
  ...
  return (
    <div style={{ position: "relative", width: "100%" }}>
      ...
      <rect x="0" y="0" width="1400" height="1600" fill={C.bg} />
      <rect x="0" y="0" width="1400" height="1600" fill="url(#dots)" opacity="0.45" />

      <rect x="40" y="35" width="640" height="380" rx="14" fill="#eff6ff" stroke="#bfdbfe" />
      ...
      <rect x="120" y="680" width="1160" height="410" rx="14" fill="#ecfdf5" stroke="#a7f3d0" />
      <text x="138" y="707" fontSize="12" fontWeight="800" fill={C.backend} letterSpacing="1.4">INTELLIGENCE & ORCHESTRATION</text>
      <rect x="730" y="470" width="290" height="130" rx="12" fill="#ecfeff" stroke="#99f6e4" />
      <text x="748" y="492" fontSize="11" fontWeight="800" fill={C.ingestFlow} letterSpacing="1.2">INGESTION</text>

      <rect x="470" y="1160" width="900" height="140" rx="14" fill="#fffbeb" stroke="#fde68a" />
      <text x="488" y="1187" fontSize="12" fontWeight="800" fill={C.data} letterSpacing="1.4">DATA & STORAGE</text>

      <rect x="40" y="1160" width="280" height="230" rx="14" fill="#fef2f2" stroke="#fecaca" />
      <text x="58" y="1187" fontSize="12" fontWeight="800" fill={C.admin} letterSpacing="1.4">ADMIN</text>
      ...
      <g transform="translate(1090, 1500)">
